...
//booking
export const GET_ALL_BOOKING_START = 'GET_ALL_BOOKING_START';
...
export const GET_ALL_MEDICINE_START = 'GET_ALL_MEDICINE_START';
export const GET_ALL_MEDICINE_SUCCESS = 'GET_ALL_MEDICINE_SUCCESS';
export const GET_ALL_MEDICINE_FAIL = 'GET_ALL_MEDICINE_FAIL';

// Statistic

export const GET_ALL_STATISTIC_START = 'GET_ALL_STATISTIC_START';
export const GET_ALL_STATISTIC_SUCCESS = 'GET_ALL_STATISTIC_SUCCESS';
export const GET_ALL_STATISTIC_FAIL = 'GET_ALL_STATISTIC_FAIL';
